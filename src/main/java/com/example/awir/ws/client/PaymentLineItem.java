 ...
 *         &lt;element name="PayeeAccount" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}Account" minOccurs="0"/&gt;
 *         &lt;element ref="{http://wi.zut.edu.pl/xsd/payment/v1.0}CardIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="PayeeFinancialInstitution" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}FinancialInstitution"/&gt;
 *         &lt;element ref="{http://wi.zut.edu.pl/xsd/payment/v1.0}Charge" minOccurs="0"/&gt;
 *         &lt;element ref="{http://wi.zut.edu.pl/xsd/payment/v1.0}RegulatoryReport" minOccurs="0"/&gt;
