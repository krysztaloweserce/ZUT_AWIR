 ...
 *         &lt;element name="ChargeAccount" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}Account" minOccurs="0"/&gt;
 *         &lt;element name="PayorFinancialInstitution" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}FinancialInstitution"/&gt;
 *         &lt;element name="PmtAdditionalInformation" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max210text" minOccurs="0"/&gt;
 *         &lt;element name="ChargeResponsibility" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}ResponsibilityCode" minOccurs="0"/&gt;
 *         &lt;element name="PaymentStatus" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}PaymentStatusType" minOccurs="0"/&gt;
 *         &lt;element name="PaymentRejectionInfo" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}TransactionRejectionType" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalDetails" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}AdditionalDetailsType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
