 ...
 *         &lt;element name="StreetName" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max35text" minOccurs="0"/&gt;
 *         &lt;element name="PostCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="CityName" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max26text" minOccurs="0"/&gt;
 *         &lt;element name="PostalAddressLine1" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max70text" minOccurs="0"/&gt;
 *         &lt;element name="PostalAddressLine2" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max70text" minOccurs="0"/&gt;
 *         &lt;element name="Country" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}CountryCode" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
