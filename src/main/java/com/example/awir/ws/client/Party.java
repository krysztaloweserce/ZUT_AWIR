 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Identifier" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}PartyIdentType" minOccurs="0"/&gt;
 *         &lt;element name="Name" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max35text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="AdditionalName" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max70text" minOccurs="0"/&gt;
 *         &lt;element name="Description" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max210text" minOccurs="0"/&gt;
 *         &lt;element name="UltmName" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}max70text" minOccurs="0"/&gt;
 *         &lt;element ref="{http://wi.zut.edu.pl/xsd/payment/v1.0}Address" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
