 ...
 *       &lt;sequence&gt;
 *         &lt;element name="SourceCurrencyIdentificationCode" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}CurrencyCode"/&gt;
 *         &lt;element name="TargetCurrencyIdentificationCode" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}CurrencyCode"/&gt;
 *         &lt;element name="CurrencyExchangeRate" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}Numeric" minOccurs="0"/&gt;
 *         &lt;element name="SourceCurrencyScaleValue" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}Numeric" minOccurs="0"/&gt;
 *         &lt;element name="TargetCurrencyScaleValue" type="{http://wi.zut.edu.pl/xsd/payment/v1.0}Numeric" minOccurs="0"/&gt;
